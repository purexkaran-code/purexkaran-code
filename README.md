...
### 💡 Featured Projects
* **Jal-Drishti:** An AI-powered urban flood early warning system utilizing Python, Streamlit, and the Pathway framework.
* **Access More:** An autonomous research and study kit generator built with React, Vite, and the Gemini API.
* **Student Performance Dashboard:** A robust MERN stack web application with fully integrated frontend components and backend REST endpoints.
* **Fin-Sense Guard:** A financial literacy and spending monitoring application proposal designed specifically for student behavioral spending.
